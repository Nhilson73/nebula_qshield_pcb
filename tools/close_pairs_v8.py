...
def via_size(name):
    c=netclasses(name)
    if 'RelayHV' in c or 'HighCurrent' in c: return (1.0,0.5)
    if 'Power' in c: return (0.8,0.4)
    if 'Analog' in c: return (0.5,0.2)
    return (0.5,0.2)
def clearance(n1,n2):
