...
```
    ...
    │  ┌───────────────────────────────────────────────────────┐     │
    │  │                                                       │     │
    │  │  ZONA A: POTENCIA           ZONA B: ANALÓGICA        │     │
    │  │  ┌─────────────────┐        ┌────────────────────┐   │     │
    │  │  │ J17 (12V input) │        │ J1 (pH BNC)        │   │     │
    │  │  │ D1 TVS          │        │ J2 (ORP BNC)       │   │  53.3
    │  │  │ F1 PTC          │        │ J4 (DO BNC)        │   │  mm
    │  │  │ D2 Schottky     │        │ J3 (CO₂ JST)      │   │     │
    │  │  │ U1 TPS54302     │        │ J5 (NTC JST)       │   │     │
    │  │  │ U2 AMS1117      │        │ J6 (Hum JST)       │   │     │
    │  │  │ LEDs            │        │ U3 Op-amps         │   │     │
    │  │  └─────────────────┘        │ Filtros RC          │   │     │
    │  │                             │ Guard ring GND      │   │     │
    │  │  ZONA D: ACTUADORES         └────────────────────┘   │     │
    │  │  ┌─────────────────┐                                  │     │
    │  │  │ J18-J20 Terms   │        ZONA C: DIGITAL          │     │
    │  │  │ K1, K2 Relays   │        ┌────────────────────┐   │     │
    │  │  │ U7 IR2104       │        │ J7-J13 I2C (Qwiic) │   │     │
    │  │  │ Q1-Q5 MOSFETs  │        │ J14 Load cell       │   │     │
    │  │  │ U8-U11 Optos    │        │ U4 ISO7721         │   │     │
    │  │  │ D9-D13 Flyback  │        │ U6 HX711           │   │     │
    │  │  │ F2-F4 PTC       │        │ J_HMI UART (JST-XH) │   │     │
    │  │  └─────────────────┘        │ J_RS485 (DNP)       │   │     │
    │  │                             └────────────────────┘   │     │
    │  │                                                       │     │
    │  │  ┌───────────────────────────────────────────────┐   │     │
    │  │  │    J21 — ARDUINO UNO SHIELD HEADER (2×20)     │   │     │
    │  │  └───────────────────────────────────────────────┘   │     │
    │  │                                                       │     │
    │  └───────────────────────────────────────────────────────┘     │
    └────────────────────────────────────────────────────────────────┘
